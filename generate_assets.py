...
def draw_blob_tree(pixels, start_x, width, height, season, style):
    ...
    if season == 'growth1': trunk_h, trunk_w, canopy_r = 10, 2, 0
    elif season == 'growth2': trunk_h, trunk_w, canopy_r = 18, 3, 8
    elif season == 'growth3': trunk_h, trunk_w, canopy_r = 30, 4, 14
